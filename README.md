...
*	Understand the basics of physical computing using arduino and basic circuits.
*	Have an introductory knowledge of other computational and procedural approaches to design and art making. This may include, Pure Data, Max, Touch Designer and procedural code with Unity and/or Unreal Engine.
...
## Important Dates
*	Wed September 8th, Classes start
*	Weds, September 15th last day of drop/add
*	Monday, December 6th day to withdraw with a W
*	Thurs, November 25 - Friday, November 26 Thanksgiving break, no classes
*	Tuesday December 14 last day of classes in semester

## Course structure
While we will be meeting weekly in class, technical lectures will be provided as online videos for you to go through at your own pace each week. You will have homework assignments based on these videos. We will spend time in class reinforcing the concepts that are covered, talk about how these relate to other topics, and conduct ourselves in a format that is conducive to conversation and group learning. Bringing your work to demonstrate and show is one part of this process, being open to critique, and willing to enage other people about their work is another part. The success of this course depends quite a bit on your participation.
...
## Software
*	A code editor like ⦁[Brackets](https://brackets.io/) , ⦁	[Sublime Text](https://www.sublimetext.com/) , ⦁	[Atom](https://atom.io/) or ⦁	[Visual Studio Code](https://code.visualstudio.com/?wt.mc_id=DX_841432).
*	The ⦁	[Arduino IDE](https://www.arduino.cc/en/software)
*	an account with the ⦁	[p5.js online editor](https://editor.p5js.org/)


## Hardware
We’ll be distributing equipment in class during the first two weeks.
...
Practice makes perfect. The more time you spend writing code and playing with these tools, the better versed you will be come in their possibilities. We suggest that instead of spending 8 hours the night before class trying to cram in everything, you spend time each day practicing programming. Besides, it should be fun! Coding is a journey 😊
...
*	Journal (includes reading resources) and Documentation- 10%
*	Midterm - 20%
*	Final - 35%
*	Class participation - 20%
 
## Midterm
Your midterm assignment is designed to demonstrate competency in the fundamentals of object oriented programming and interaction. We will discuss the specifics of this a few weeks before it is due. You will make your own interactive, screen based artwork. Your sketch should contain at least 1 object, but if your sketch is data based or using JSON, that is also acceptable. Taking into consideration responsiveness, accessibility, and aesthetics there should be some form of interaction for your audience. This could be through keypresses, mouse movements, GUI objects, etc. You should feel free to use APIs libraries or any other thing we ave discussed in class to date. You code must be clearly and thoroughly commented througout - indicating what is your original contribution and what you have gotten from elsewhere. Documentation of your process is necessary. Grading of the assignment will be 10% documentation, 20% presentation (concpetual, visual and other attributes like sound and form that contribute to the delivery of your intention) the remaining will be a scale between your execution of the project and your demonstration of learning and growth from the begiing of class. 
